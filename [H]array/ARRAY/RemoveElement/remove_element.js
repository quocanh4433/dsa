...
Ưu điểm: giữ được thứ tự trong mảng
...
console.log(removeElement([1, 1, 2, 3, 4, 0], 1)); // 4
...
Nhược điểm: Thứ tự mảng bị thay đổi so với cách trên
...
console.log("2: ", removeElement_2([1, 1, 2, 3, 4, 0], 1)); // 4
console.log("2: ", removeElement_2([0, 1, 2, 2, 3, 0, 4, 2], 2)); // 5
